 ...
 * Use the [FragmentProductListSearchProductTerlaris.newInstance] factory method to
...
class FragmentProductListSearchProductTerlaris : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentProductListSearchProductTerlaris.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            FragmentProductListSearchProductTerlaris().apply {
