...
class DetailOfficialStoreActivity : AppCompatActivity() {
  ...
  var data: OfficialStoreDomainItemModel = OfficialStoreDomainItemModel(
    1,
    "test",
    "https://cleopurewater.com/wp-content/uploads/2022/05/logo-cleo-2022-w400.png",
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTn-ckIDh6B9Iz0Rhzq3SudYILrV0hBg9B9wkdhIdlFlQ&s",
    listOf(),
    0
  )

  //    lateinit var data:OfficialStoreDomainItemModel
  ...
  private fun setUpData(data: OfficialStoreDomainItemModel) {
    with(binding) {
