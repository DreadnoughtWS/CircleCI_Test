...
class AdapterSubMenuPesanan (private val subMenuPesanan: MutableList<String>): RecyclerView.Adapter<AdapterSubMenuPesanan.SubmenuPesananViewHolder>() {
    class SubmenuPesananViewHolder(val binding: ItemSubmenuPesananBinding): ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubmenuPesananViewHolder {
        return SubmenuPesananViewHolder(ItemSubmenuPesananBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
