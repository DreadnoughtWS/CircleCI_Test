...
interface ProductListDomainUseCase {
    ...
    suspend fun getProductSearchProductOrder(scope: CoroutineScope,name:String,order:String,sort:String,type:String) : Flow<PagingData<ProductListPromotionProductDomainModel>>
    suspend fun getProductSearchProduct(scope: CoroutineScope,name:String,type: String) : Flow<PagingData<ProductListPromotionProductDomainModel>>
